...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive educational resources about 1 oz gold bars covering premiums, liquidity, storage, brand comparisons, and investment strategies.",
  alternates: {
...
export default async function ResourcesPage({ searchParams }: PageProps) {
  ...
  const webPageSchema = {
    ...
    "@type": "CollectionPage",
    name: "1 oz Gold Bar Resources & Educational Guides",
    description:
      "Comprehensive educational resources about 1 oz gold bars covering premiums, liquidity, storage, brand comparisons, and investment strategies.",
    url: `${SITE_CONFIG.domain}/resources`,
    publisher: {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed mt-6">
              Deepen your understanding of 1 oz gold bars with our comprehensive 
              guides covering everything from premiums and liquidity to storage 
              and market dynamics. Check{" "}
