...
export const metadata: Metadata = {
  title: "About | 1ozGoldBars.com",
  description:
    "Learn about 1ozGoldBars.com, an independent educational resource about 1 oz gold bars. We do not sell precious metals or provide financial advice.",
  alternates: {
  ...
  openGraph: {
    title: "About | 1ozGoldBars.com",
    description:
      "Learn about 1ozGoldBars.com, an independent educational resource about 1 oz gold bars.",
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              An independent educational resource for gold bar investors
            </p>
          </div>
          ...
          <div className="space-y-10">
            ...
            <section className="card p-6 md:p-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                ...
                {SITE_CONFIG.primaryProduct}—the most liquid, divisible, and
                globally recognized form of gold bullion.
              </p>
              <p className="text-gray-300 leading-relaxed">
                Our mission is to provide clear, unbiased information about gold
                bar investing, including pricing mechanics, storage options,
                brand comparisons, and market dynamics.
              </p>
            </section>
            ...
            <section className="card p-6 md:p-8">
              ...
              <ul className="space-y-2 text-gray-300 mb-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">GBOZ</strong> – 1 oz Gold
                    Bullion Ounce price
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-bullion-gold">•</span>
                  <span>
                    <strong className="text-white">GBXSPOT</strong> – Gold Spot
                    Index (raw spot price)
                  </span>
                </li>
              </ul>
