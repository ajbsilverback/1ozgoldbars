        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg gold-gradient flex items-center justify-center">
                <span className="text-black font-bold text-lg">1oz</span>
              </div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              Helping investors understand the benefits of highly liquid, 
              divisible gold bar holdings.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href="/resources/liquidity-benefits"
                  className="text-gray-400 hover:text-bullion-gold transition-colors text-sm"
                >
                  Liquidity Benefits
                </Link>
