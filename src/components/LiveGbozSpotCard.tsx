...
import { fetchGbozSpot, formatUSD, formatChange, formatTimestamp } from "@/lib/monexSpot";
...
/**
 * Server Component - Fetches GBOZ price ONCE per page load
 * 
...
export default async function LiveGbozSpotCard({ showCta = true }: LiveGbozSpotCardProps) {
  const data = await fetchGbozSpot();
    ...
    <div className="max-w-3xl mx-auto rounded-xl border border-bullion-gold/30 shadow-md p-6 sm:p-10 bg-[#111] space-y-6">
      ...
      <div className="relative text-center py-6">
        ...
        <div className="relative">
          ...
          <p className="text-lg text-gray-400 mt-2">per troy ounce</p>
        </div>
      </div>
